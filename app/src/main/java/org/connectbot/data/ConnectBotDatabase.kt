 ...
 * - Version 3: Added profiles table and profile_id column to hosts (manual migration)
...
abstract class ConnectBotDatabase : RoomDatabase() {
    ...
    companion object {
        /**
         * Migration from version 2 to 3: Add profiles table and profile_id to hosts.
