...
class ProfileEditorScreenTest {
    ...
    @Test
    fun profileEditorScreen_newProfile_displaysTitle() {
        ...
        composeTestRule
            .onNodeWithText("New Profile")
            .assertIsDisplayed()
    }

    @Test
    fun profileEditorScreen_hasBackButton() {
        var backCalled = false

        composeTestRule.setContent {
            ConnectBotTheme {
                ProfileEditorScreen(onNavigateBack = { backCalled = true })
            }
        }
    ...
    @Test
    fun profileEditorScreen_displaysNameField() {
        composeTestRule.setContent {
            ConnectBotTheme {
                ProfileEditorScreen(onNavigateBack = {})
            }
