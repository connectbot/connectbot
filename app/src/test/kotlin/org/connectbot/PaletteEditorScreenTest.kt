...
class PaletteEditorScreenTest {
    ...
    @Test
    fun paletteEditorScreen_displaysTitle() {
        ...
        composeTestRule
            .onNodeWithText("Edit Color Palette")
            .assertIsDisplayed()
    }

    @Test
    fun paletteEditorScreen_hasBackButton() {
    ...
    @Test
    fun paletteEditorScreen_hasResetButton() {
        composeTestRule.setContent {
            ConnectBotTheme {
                PaletteEditorScreen(
                    onNavigateBack = {},
